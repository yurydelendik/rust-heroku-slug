...
GET_RUSTFMT_URL=${shell node utils/toml_value.js downloads/linux_channel.toml pkg.rustfmt-preview.target.x86_64-unknown-linux-gnu url}
...
downloads/linux_rustfmt.tar.gz: downloads/linux_channel.toml
	curl ${GET_RUSTFMT_URL} -o downloads/linux_rustfmt.tar.gz

app/rust: downloads/linux_cargo.tar.gz downloads/linux_rustc.tar.gz downloads/wasm_rust_std.tar.gz downloads/linux_rustfmt.tar.gz
	mkdir -p app/rust
	...
	tar -C app/rust/ --strip-components=2 -xvf downloads/linux_rustfmt.tar.gz "*/rustfmt"
